...
(() => {
  ...
  if (!img) return;
  const slides = ["assets/hero/064c6f25-f428-4624-90b1-db024db8bfd8.png", "assets/hero/53b711f2-6464-48be-8b0e-d01b4af01e80.png", "assets/hero/595aa949-f336-4101-ba1e-92ed74d235e0.png", "assets/hero/hero-blue-house.png", "assets/hero/hero-courtyard.png"];
  ...
  (hero.querySelector('.hero-visual') || hero).append(controls);
  ...
  const render = () => {
    img.dataset.composition = /hero-(blue-house|courtyard)\.png$/.test(slides[current]) ? 'right' : 'center';
